              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    <span className="font-medium">Attention:</span> Aucune donnée réelle n'a été trouvée pour cet indicateur. Des données de démonstration sont affichées à titre d'exemple.
                  </p>
                </div>
              </div>
            </div>
