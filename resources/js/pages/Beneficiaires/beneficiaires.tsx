...
// //                                 {/* Bouton Ajouter un bénéficiaire */}
// //                                 <button
...
//             beneficiaire.region.toLowerCase().includes(searchTerm.toLowerCase()) ||
...
//                                                     </td>
//                                                     <td className="px-6 py-4 whitespace-nowrap">
//                                                         <div className="text-sm text-gray-900">{beneficiaire.region}</div>
        ...
        if (confirmDelete === id) {
            router.delete(route('beneficiaires.destroy', id), {
                onSuccess: () => {
                    toast.success("Bénéficiaire supprimé avec succès");
                    setConfirmDelete(null);
                    // Si on est en train de visualiser ce bénéficiaire, retourner à la liste
