...
import { Building, Users, FileText, Database, Briefcase, UserCheck, AlertTriangle, Shield } from 'lucide-react';
...
export default function Dashboard({ auth, stats = {} }: { auth: Auth; stats?: Stats }) {
  ...
  const moduleCards = [
    ...
    // Ajouter ce module à votre tableau moduleCards:
{
    name: 'Rôles et Permissions',
    description: 'Gestion des rôles et permissions',
    icon: Shield, // Importez cette icône de lucide-react
    color: 'bg-teal-600',
    count: stats.roles || 0,
    route: 'roles.index',
    permission: 'utilisateurs', // Utilise les mêmes permissions que le module utilisateurs
    action: 'view'
  }
  ];
