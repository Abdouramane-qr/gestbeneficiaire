    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                        ...
                        <div className="space-y-2">
                            <p className="flex items-start">
                                ...
                                <span className="text-gray-900 dark:text-gray-100">{beneficiaire.region}</span>
                            </p>
                            <p className="flex items-start">
            ...
            <div className="mt-6 space-y-4">
                <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400">{beneficiaire.institutionFinanciere ? beneficiaire.institutionFinanciere.nom : "Aucune"}</p>
                        </div>
                    </div>
                </div>
                ...
                {beneficiaire.entreprises && beneficiaire.entreprises.length > 0 && (
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                        <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-3">Entreprises associées</h2>
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                <thead>
                                    <tr>
                                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nom</th>
                                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Secteur d'activité</th>
                                    </tr>
                                </thead>
                                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                                    {beneficiaire.entreprises.map(entreprise => (
                                        <tr key={entreprise.id}>
                                            <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">{entreprise.nom_entreprise}</td>
                                            <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{entreprise.secteur_activite}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                ...
                {(!beneficiaire.entreprises || beneficiaire.entreprises.length === 0) && (
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
                        <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-3">Entreprises associées</h2>
                        <p className="text-gray-500 dark:text-gray-400">Aucune entreprise associée.</p>
                    </div>
                )}
            </div>
        </div>
