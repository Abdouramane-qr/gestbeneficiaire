...
//     isOpen: boolean;
//     closeModal: () => void;
//     onSuccess: () => void; // 🔥 Ajout de cette fonction
...
// const OngFormModal = ({ isOpen, closeModal, ong }: OngFormModalProps) => {
...
//                 closeModal();
//                 reset();
//                 //router.reload(); // 🔄 Recharge la page pour voir les changements
//                 onSuccess(); // 🔥 Met à jour la liste sans rafraîchir la page
...
//         if (ong?.id) {
//             put(route('ong.update', ong.id), options);
//         } else {
//             post(route('ong.store'), options);
//         }
//     };
